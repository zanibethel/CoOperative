-- Generated verbatim from database/schema-v0.2-operative.sql (the reviewed
-- reference schema for Issue #4 Gate 1) via `supabase migration new
-- cloud_operative_v0_2`. This is the versioned migration file Supabase's CLI
-- tracks in the remote migration history; database/schema-v0.2-operative.sql
-- remains the human-reviewed reference copy and is not itself applied.
--
